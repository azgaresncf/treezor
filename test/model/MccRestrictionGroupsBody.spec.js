...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('MccRestrictionGroupsBody', function() {
      beforeEach(function() {
        instance = new Treezor.MccRestrictionGroupsBody();
      });

      it('should create an instance of MccRestrictionGroupsBody', function() {
        // TODO: update the code to test MccRestrictionGroupsBody
        expect(instance).to.be.a(Treezor.MccRestrictionGroupsBody);
      });
