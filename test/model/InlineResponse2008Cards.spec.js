...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse2008Cards', function() {
      beforeEach(function() {
        instance = new Treezor.InlineResponse2008Cards();
      });

      it('should create an instance of InlineResponse2008Cards', function() {
        // TODO: update the code to test InlineResponse2008Cards
        expect(instance).to.be.a(Treezor.InlineResponse2008Cards);
      });
