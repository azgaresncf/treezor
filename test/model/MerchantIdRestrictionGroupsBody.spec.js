...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('MerchantIdRestrictionGroupsBody', function() {
      beforeEach(function() {
        instance = new Treezor.MerchantIdRestrictionGroupsBody();
      });

      it('should create an instance of MerchantIdRestrictionGroupsBody', function() {
        // TODO: update the code to test MerchantIdRestrictionGroupsBody
        expect(instance).to.be.a(Treezor.MerchantIdRestrictionGroupsBody);
      });
