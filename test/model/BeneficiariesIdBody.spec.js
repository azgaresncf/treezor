...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('BeneficiariesIdBody', function() {
      beforeEach(function() {
        instance = new Treezor.BeneficiariesIdBody();
      });

      it('should create an instance of BeneficiariesIdBody', function() {
        // TODO: update the code to test BeneficiariesIdBody
        expect(instance).to.be.a(Treezor.BeneficiariesIdBody);
      });
