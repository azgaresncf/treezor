...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse20019', function() {
      beforeEach(function() {
        instance = new Treezor.InlineResponse20019();
      });

      it('should create an instance of InlineResponse20019', function() {
        // TODO: update the code to test InlineResponse20019
        expect(instance).to.be.a(Treezor.InlineResponse20019);
      });

      it('should have the property payouts (base name: "payouts")', function() {
        // TODO: update the code to test the property payouts
        expect(instance).to.have.property('payouts');
        // expect(instance.payouts).to.be(expectedValueLiteral);
      });
