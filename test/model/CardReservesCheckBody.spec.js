...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CardReservesCheckBody', function() {
      beforeEach(function() {
        instance = new Treezor.CardReservesCheckBody();
      });

      it('should create an instance of CardReservesCheckBody', function() {
        // TODO: update the code to test CardReservesCheckBody
        expect(instance).to.be.a(Treezor.CardReservesCheckBody);
      });
