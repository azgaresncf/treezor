...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('MerchantIdRestrictionGroupsIdBody', function() {
      beforeEach(function() {
        instance = new Treezor.MerchantIdRestrictionGroupsIdBody();
      });

      it('should create an instance of MerchantIdRestrictionGroupsIdBody', function() {
        // TODO: update the code to test MerchantIdRestrictionGroupsIdBody
        expect(instance).to.be.a(Treezor.MerchantIdRestrictionGroupsIdBody);
      });
