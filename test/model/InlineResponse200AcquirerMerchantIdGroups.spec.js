...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse200AcquirerMerchantIdGroups', function() {
      beforeEach(function() {
        instance = new Treezor.InlineResponse200AcquirerMerchantIdGroups();
      });

      it('should create an instance of InlineResponse200AcquirerMerchantIdGroups', function() {
        // TODO: update the code to test InlineResponse200AcquirerMerchantIdGroups
        expect(instance).to.be.a(Treezor.InlineResponse200AcquirerMerchantIdGroups);
      });
