...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse20011CountryRestrictionGroups', function() {
      beforeEach(function() {
        instance = new Treezor.InlineResponse20011CountryRestrictionGroups();
      });

      it('should create an instance of InlineResponse20011CountryRestrictionGroups', function() {
        // TODO: update the code to test InlineResponse20011CountryRestrictionGroups
        expect(instance).to.be.a(Treezor.InlineResponse20011CountryRestrictionGroups);
      });
