...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CountryRestrictionGroupsBody', function() {
      beforeEach(function() {
        instance = new Treezor.CountryRestrictionGroupsBody();
      });

      it('should create an instance of CountryRestrictionGroupsBody', function() {
        // TODO: update the code to test CountryRestrictionGroupsBody
        expect(instance).to.be.a(Treezor.CountryRestrictionGroupsBody);
      });
