...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CountryRestrictionGroupsIdBody', function() {
      beforeEach(function() {
        instance = new Treezor.CountryRestrictionGroupsIdBody();
      });

      it('should create an instance of CountryRestrictionGroupsIdBody', function() {
        // TODO: update the code to test CountryRestrictionGroupsIdBody
        expect(instance).to.be.a(Treezor.CountryRestrictionGroupsIdBody);
      });
