...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AcquirerMerchantIdGroupsBody', function() {
      beforeEach(function() {
        instance = new Treezor.AcquirerMerchantIdGroupsBody();
      });

      it('should create an instance of AcquirerMerchantIdGroupsBody', function() {
        // TODO: update the code to test AcquirerMerchantIdGroupsBody
        expect(instance).to.be.a(Treezor.AcquirerMerchantIdGroupsBody);
      });
