...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse20015MccRestrictionGroups', function() {
      beforeEach(function() {
        instance = new Treezor.InlineResponse20015MccRestrictionGroups();
      });

      it('should create an instance of InlineResponse20015MccRestrictionGroups', function() {
        // TODO: update the code to test InlineResponse20015MccRestrictionGroups
        expect(instance).to.be.a(Treezor.InlineResponse20015MccRestrictionGroups);
      });
