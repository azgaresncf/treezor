...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('MccRestrictionGroupsIdBody', function() {
      beforeEach(function() {
        instance = new Treezor.MccRestrictionGroupsIdBody();
      });

      it('should create an instance of MccRestrictionGroupsIdBody', function() {
        // TODO: update the code to test MccRestrictionGroupsIdBody
        expect(instance).to.be.a(Treezor.MccRestrictionGroupsIdBody);
      });
