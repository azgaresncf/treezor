...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CardReservesAddToBody', function() {
      beforeEach(function() {
        instance = new Treezor.CardReservesAddToBody();
      });

      it('should create an instance of CardReservesAddToBody', function() {
        // TODO: update the code to test CardReservesAddToBody
        expect(instance).to.be.a(Treezor.CardReservesAddToBody);
      });
