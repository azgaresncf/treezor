...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('BeneficiariesBody', function() {
      beforeEach(function() {
        instance = new Treezor.BeneficiariesBody();
      });

      it('should create an instance of BeneficiariesBody', function() {
        // TODO: update the code to test BeneficiariesBody
        expect(instance).to.be.a(Treezor.BeneficiariesBody);
      });
