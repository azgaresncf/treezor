...
import {InlineResponse2006Cards} from './InlineResponse2006Cards';
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('cards'))
        obj.cards = ApiClient.convertToType(data['cards'], [InlineResponse2006Cards]);
    }
    return obj;
  }
}
...
/**
 * @member {Array.<module:model/InlineResponse2006Cards>} cards
 */
InlineResponse2006.prototype.cards = undefined;
