...
import {InlineResponse2007Cardimages} from './InlineResponse2007Cardimages';
...
export class InlineResponse2007 {
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('cardimages'))
        obj.cardimages = ApiClient.convertToType(data['cardimages'], [InlineResponse2007Cardimages]);
    }
    return obj;
  }
}
...
/**
 * @member {Array.<module:model/InlineResponse2007Cardimages>} cardimages
 */
InlineResponse2007.prototype.cardimages = undefined;
